...
import mobi.allshoppings.bz.DashboardTimelineDataByProvinceBzService;
...
implements DashboardTimelineDataByProvinceBzService {
	...
	private static final Logger log = Logger.getLogger(DashboardTimelineDataByProvinceBzServiceJSONImpl.class.getName());
