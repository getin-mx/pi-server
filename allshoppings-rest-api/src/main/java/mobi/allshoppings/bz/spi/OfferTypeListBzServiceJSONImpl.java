 ...
 *
 */
public class OfferTypeListBzServiceJSONImpl extends RestBaseServerResource implements TableListBzService {

    private static final Logger log = Logger.getLogger(OfferTypeListBzServiceJSONImpl.class.getName());
    ...
    public String retrieve() {
		...
		try {
			List<OfferType> list = new ArrayList<OfferType>();
			...
			trackerHelper.enqueue(user, getRequestIP(),
					...
					getI18NMessage("es_AR", "service.OfferTypeListBzService"),
					null, null);
