...
import mobi.allshoppings.bz.DashboardHeatmapTableDataBzService;
 ...
 *
 */
public class DashboardHeatmapTableDataBzServiceJSONImpl
extends RestBaseServerResource
implements DashboardHeatmapTableDataBzService {

	private static final Logger log = Logger.getLogger(DashboardHeatmapTableDataBzServiceJSONImpl.class.getName());
