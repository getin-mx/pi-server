 ...
 *
 */
public class DashboardBrandTableData2BzServiceJSONImpl
extends RestBaseServerResource
implements DashboardBrandTableDataBzService {

	private static final Logger log = Logger.getLogger(DashboardBrandTableData2BzServiceJSONImpl.class.getName());
