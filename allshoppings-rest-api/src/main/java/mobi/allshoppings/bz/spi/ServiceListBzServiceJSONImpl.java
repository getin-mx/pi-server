 ...
 *
 */
public class ServiceListBzServiceJSONImpl extends RestBaseServerResource implements TableListBzService {

    private static final Logger log = Logger.getLogger(ServiceListBzServiceJSONImpl.class.getName());
    ...
    public String retrieve() {
		...
		try {
			...
			trackerHelper.enqueue(user, getRequestIP(),
					...
					getI18NMessage("es_AR", "service.ServiceListBzService"),
					null, null);
