...
@Cacheable("false")
public class MonthlyDashboardIndicatorData extends DashboardIndicatorData implements ModelKey, Serializable, Identificable {

    public Key key;

	public MonthlyDashboardIndicatorData() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MonthlyDashboardIndicatorData other = (MonthlyDashboardIndicatorData) obj;
		if (elementId == null) {
