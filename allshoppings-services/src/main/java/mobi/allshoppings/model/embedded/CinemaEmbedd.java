...
@EmbeddedOnly
public class CinemaEmbedd implements Serializable {
	 ...
	 * @param name
	 */
	public CinemaEmbedd(String identifier, String name, String internalIdentifier) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CinemaEmbedd other = (CinemaEmbedd) obj;
		if (identifier == null) {
	...
	public String toString() {
		return "CinemaEmbedd [identifier=" + identifier
