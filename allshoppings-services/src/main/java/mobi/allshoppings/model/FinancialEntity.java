...
@PersistenceCapable
public class FinancialEntity implements ModelKey, Serializable, Identificable, Indexable, ViewLocationAware, ACLAware, StatusAware, Replicable {
	...
	public String toString() {
		return "FinancialEntity [key=" + key + ", name=" + name + "]";
	}
