...
public class APDVAnalysis implements ModelKey, Serializable, Identificable, Replicable {
	...
	@Persistent(defaultFetchGroup = "true")
	private Map<String, Integer> visitRssi;
	@Persistent(defaultFetchGroup = "true")
	private Map<String, Integer> peasantRssi;
	...
	public APDVAnalysis(String hostname, String mac, String date) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		APDVAnalysis other = (APDVAnalysis) obj;
		if (date == null) {
			if (other.date != null)
				return false;
