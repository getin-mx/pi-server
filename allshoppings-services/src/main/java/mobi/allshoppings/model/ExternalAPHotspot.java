...
public class ExternalAPHotspot implements ModelKey, Serializable, Identificable, Replicable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExternalAPHotspot other = (ExternalAPHotspot) obj;
		if (key == null) {
			if (other.key != null)
				return false;
