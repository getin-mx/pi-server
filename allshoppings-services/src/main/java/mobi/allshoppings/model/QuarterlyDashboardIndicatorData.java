...
@Cacheable("false")
public class QuarterlyDashboardIndicatorData extends DashboardIndicatorData implements ModelKey, Serializable, Identificable {

    public Key key;

	public QuarterlyDashboardIndicatorData() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QuarterlyDashboardIndicatorData other = (QuarterlyDashboardIndicatorData) obj;
		if (elementId == null) {
