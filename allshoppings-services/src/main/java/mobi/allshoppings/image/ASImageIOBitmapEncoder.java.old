 ...
 */
public class ASImageIOBitmapEncoder implements ASBitmapEncoder {
     ...
     */
    public ASImageIOBitmapEncoder() throws ClassNotFoundException {
    ...
    public void dumpMetadata(IIOMetadata iiometa) {
        String[] metanames = iiometa.getMetadataFormatNames();
