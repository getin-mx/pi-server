...
public interface PointsService {
	...
	void enqueue(final String userId, final Integer action, final Integer targetKind, final String targetId, final String data) throws ASException;
	long calculatePointsForAction(final String userId, final Integer action, final Integer targetKind, final String targetId, String data);
	long assignPointsForAction(final String userId, final Integer action, final Integer targetKind, final String targetId, String data) throws ASException;
