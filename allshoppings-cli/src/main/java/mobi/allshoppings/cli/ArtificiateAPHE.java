...
public class ArtificiateAPHE extends AbstractCLI {

	private static final Logger log = Logger.getLogger(ArtificiateAPHE.class.getName());
	...
	public static void main(String args[]) throws ASException {
		try {
			...
			helper.artificiateRSSI(apdevices, fromDate, toDate);
