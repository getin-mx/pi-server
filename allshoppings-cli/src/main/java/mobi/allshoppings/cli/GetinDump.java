...
//			GeoCodingHelper geocoder = (GeoCodingHelper)getApplicationContext().getBean("geocoding.helper");
			...
			stores.add(new StoreAdapter("175", "Sportium Satelite", "sportium_mx", "plazasatelite", GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("176", "Sportium Cuautitlan", "sportium_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("177", "Sportium Arboledas", "sportium_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("178", "Sportium Coyoacan", "sportium_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("179", "Sportium Del Valle", "sportium_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("180", "Sportium San Angel", "sportium_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("181", "Sportium Desierto", "sportium_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("182", "Sportium Santa Fe", "sportium_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("134", "Chilim Balam Toreo", "chilimbalam_mx", "toreoparquecentral", GetinDump.MALL));
			stores.add(new StoreAdapter("143", "Chilim Balam Satelite", "chilimbalam_mx", "plazasatelite", GetinDump.MALL));
			stores.add(new StoreAdapter("167", "Chilim Balam Santa Fe", "chilimbalam_mx", "centrosantafe", GetinDump.MALL));
...
//			stores.add(new StoreAdapter("174", "Fullsand Aragon", "fullsand_mx", "multiplazaaragon", 0));
			...
			stores.add(new StoreAdapter("211", "Flormar Multiplaza", "flormar_pa", null, GetinDump.MALL));
			stores.add(new StoreAdapter("264", "Flormar Metromall", "flormar_pa", null, GetinDump.MALL));
			...
			stores.add(new StoreAdapter("218", "+Kota Parque Delta", "maskota_mx", "parquedelta", GetinDump.MALL));
			...
			stores.add(new StoreAdapter("224", "Bath and Body Works Satelite", "bathandbodyworks_mx", "plazasatelite", GetinDump.MALL));
			stores.add(new StoreAdapter("226", "Modatelas Tacubaya", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("260", "Modatelas Coapa", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("261", "Modatelas Chalco", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("228", "Botanicus Polanco", "botanicus_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("229", "Botanicus Condesa", "botanicus_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("230", "Botanicus Mercado Roma", "botanicus_mx", "mercadoroma", GetinDump.MALL));
			stores.add(new StoreAdapter("231", "Botanicus Metropoli Patriotismo", "botanicus_mx", "metropolipatriotismo", GetinDump.MALL));
			stores.add(new StoreAdapter("253", "Botanicus La Cuspide", "botanicus_mx", "lacuspideskymall", GetinDump.MALL));
			stores.add(new StoreAdapter("254", "Botanicus Bazar Coyoacan", "botanicus_mx", "bazarcoyoacan", GetinDump.MALL));
			stores.add(new StoreAdapter("255", "Botanicus Galerias Cuernavaca", "botanicus_mx", "galeriascuernavaca", GetinDump.MALL));
			stores.add(new StoreAdapter("256", "Botanicus Plaza Cuernavaca", "botanicus_mx", "plazacuernavaca", GetinDump.MALL));
			stores.add(new StoreAdapter("257", "Botanicus Tepoztlan", "botanicus_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("258", "Botanicus Tepozteco", "botanicus_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("263", "Botanicus Malinalco", "botanicus_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("275", "Squalo Playa 1", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("276", "Squalo Monterrey", "squalo_mx", "galeriasvalleoriente", GetinDump.MALL));
			stores.add(new StoreAdapter("281", "Sunglass Hut Lerma Outlet", "sunglasshut_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("282", "Sbarro Oasis", "sbarro_mx", "forumbuenavista", GetinDump.MALL));
			stores.add(new StoreAdapter("286", "Areas México A59", "areasmexico_mx",null, GetinDump.AIRPORT));
			...
			stores.add(new StoreAdapter("303", "U by AD	Galerías Atizapan", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("304", "La Martina Santa Fe", "chomarc_mx","centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("305", "Fullsand AICM", "fullsand_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("306", "Adolfo Dominguez Duraznos", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("307", "Adolfo Dominguez Aguascalientes", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("308", "La Martina Antea Queretaro", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("309", "Adolfo Dominguez Outlet Lomas Verdes", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("310", "Adolfo Dominguez Outlet Castelar", "chomarc_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("311", "La Martina Punta Norte", "chomarc_mx",null, GetinDump.MALL));
			...
			stores.add(new StoreAdapter("315", "HR Consulting Helguera", "hrconsulting_ar",null, GetinDump.FOOT_STREET));
...
//			stores.add(new StoreAdapter("320","Sally Beauty Metepec", "sallybeauty_mx",null, 0));
			...
			stores.add(new StoreAdapter("325", "La Martina Cancún", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("326", "Adolfo Dominguez Los Cabos", "chomarc_mx",null, GetinDump.MALL)); 
			stores.add(new StoreAdapter("327", "Adolfo Dominguez Mérida", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("328", "Adolfo Dominguez Outlet Veracuz", "chomarc_mx",null, GetinDump.MALL)); 
			stores.add(new StoreAdapter("329", "Adolfo Dominguez Xalapa", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("330", "Adolfo Dominguez Outlet Xalapa", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("331", "Adolfo Dominguez Coatzacoalcos", "chomarc_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("332", "Adolfo Dominguez Monterrey", "chomarc_mx",null, GetinDump.MALL)); 
			...
			stores.add(new StoreAdapter("341", "Outlet Deportes San Je 3", "outletdeportes_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("342", "Outlet Deportes San Cosme", "outletdeportes_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("343", "Outlet Deportes Portal", "outletdeportes_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("344", "Outlet Deportes Zapamundi", "outletdeportes_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("345", "Outlet Deportes Tacuba", "outletdeportes_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("346", "Outlet Deportes Eje Central", "outletdeportes_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("347", "Outlet Deportes Isabel la Catolica", "outletdeportes_mx",null, GetinDump.MALL));
			stores.add(new StoreAdapter("348", "Botanicus San Miguel Umarán", "botanicus_mx", null, GetinDump.FOOT_STREET));
...
//			stores.add(new StoreAdapter("352", "Outlet Deportes Huinala MTY","outletdeportes_mx", null, 0));
			...
			stores.add(new StoreAdapter("356", "Outlet Deportes Hilvana Queretaro","outletdeportes_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("357", "Botanicus Valle de Bravo", "botanicus_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("367", "Modatelas Coacalco III", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("368", "Modatelas Coacalco II", "modatelas_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("374", "Modatelas Tlalnepantla I", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("375", "Modatelas Tlalnepantla III", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("376", "Modatelas Naucalpan", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("377", "Modatelas Ixtapaluca", "modatelas_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("378", "Modatelas Ixtapaluca II", "modatelas_mx", null, GetinDump.MALL));
			...
			stores.add(new StoreAdapter("388", "Modatelas Lago de Guadalupe", "modatelas_mx", null, GetinDump.MALL)); 
			stores.add(new StoreAdapter("389", "Modatelas Atizapán", "modatelas_mx", null, GetinDump.FOOT_STREET)); 
			stores.add(new StoreAdapter("390", "Modatelas Tultitlán", "modatelas_mx", null, GetinDump.MALL)); 
			...
			stores.add(new StoreAdapter("398", "Volaris Servicios Especiales", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("399", "Volaris Mesa Registro 1", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("400", "Volaris Mesa Registro 2", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("401", "Volaris Mesa Registro 3", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("402", "Volaris Columna Central", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("403", "Volaris Mesa Registro 4", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("404", "Volaris Mesa Registro 5", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("405", "Volaris Mesa Registro 6", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("406", "Volaris Banda Tansportadora 1", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("407", "Volaris Banda Tansportadora 2", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("408", "Volaris Banda Tansportadora 3", "volaris_mx", null, GetinDump.AIRPORT));
			stores.add(new StoreAdapter("409", "Best Buy Caja 1", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("410", "Best Buy Caja 2", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("411", "Best Buy Caja 3", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("412", "Best Buy Caja 4", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("413", "Best Buy Lateral 1", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("414", "Best Buy Lateral 2", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("415", "Best Buy Lateral 3", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("416", "Best Buy Lateral 4", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("417", "Best Buy Lateral 5", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("418", "Best Buy Central", "bestbuy_mx", "centrosantafe", GetinDump.MALL));
			stores.add(new StoreAdapter("419", "Modatelas La Aurora", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("420", "Modatelas Las Maravillas", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("421", "FULLSAND ACA DIAMANTE", "fullsand_mx", null, GetinDump.MALL));			
			stores.add(new StoreAdapter("433", "Monte de Piedad - 96", "montedepiedad_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("434", "Monte de Piedad - 61", "montedepiedad_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("435", "Monte de Piedad - 305", "montedepiedad_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("436", "Botanicus Tlanepantla", "botanicus_mx", null, GetinDump.KIOSK));
			stores.add(new StoreAdapter("437", "Modatelas Los Reyes", "modatelas_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("438", "Modatelas Córdoba", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("439", "Modatelas Cd. Mendoza", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("440", "Modatelas Cd Juarez", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("441", "Modatelas Cd. Juarez II", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("442", "Modatelas Coatzacoalcos", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("443", "Modatelas Minatitlán", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("444", "Modatelas Fantasy Oaxaca", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("445", "Modatelas Chihuahua II", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("446", "Modatelas Juchitán", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("447", "Modatelas Miahuatlan", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("448", "Modatelas Pinotepa", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("449", "Modatelas Oaxaca III", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("450", "Modatelas Chihuahua III", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("451", "Modatelas Nicolas Romero II", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("452", "Modatelas Oaxaca IV", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("453", "Modatelas Martínez de la Torre", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("454", "Modatelas Cd Camargo", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("455", "Modatelas Veracruz III", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("456", "Modatelas Cd Juarez III", "modatelas_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("457", "Modatelas Tuxpan", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("458", "Modatelas Puerto Escondido", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("459", "Modatelas Salina Cruz", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("460", "Modatelas Cosamaloapan", "modatelas_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("464", "Annik Desierto de los Leones", "annik_mx", "grandsanfrancisco", GetinDump.MALL));
			stores.add(new StoreAdapter("465", "Annik San Jerónimo", "annik_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("480", "98 Coast Av. Portal", "98coastav_mx", null, GetinDump.MALL));			
			...
			stores.add(new StoreAdapter("487", "Flormar Cacique", "flormar_co", null, GetinDump.MALL));
			stores.add(new StoreAdapter("488", "Flormar Lincoln Plaza", "flormar_cr", null, GetinDump.MALL));
			stores.add(new StoreAdapter("489", "Sunglass Hut Altaplaza", "sunglasshut_pa", null, GetinDump.MALL));
			stores.add(new StoreAdapter("490", "Sunglass Hut Multiplaza", "sunglasshut_pa", null, GetinDump.MALL));
			...
			stores.add(new StoreAdapter("501", "Aditivo El Rosario", "aditivo_mx", null, GetinDump.CETRAM));			
...
//			stores.add(new StoreAdapter("522","Sally Beauty Plaza Satélite", "sallybeauty_mx", null, 0));
			...
			stores.add(new StoreAdapter("526","Sally Beauty Parque Toreo", "sallybeauty_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("527","Sally Beauty Pabellón Azcapotzalco", "sallybeauty_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("528","Sally Beauty Gran Sur", "sallybeauty_mx", null, GetinDump.MALL));
...
//			stores.add(new StoreAdapter("533","Sally Beauty Oasis Coyoacán", "sallybeauty_mx", null, 0));
			...
			stores.add(new StoreAdapter("551","Farmacias YZA Reforma Marítima", "farmaciasyza_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("552","Farmacias YZA General Anaya", "farmaciasyza_mx",null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("553","Farmacias YZA Lazaro", "farmaciasyza_mx",null, GetinDump.FOOT_STREET));
...
//			stores.add(new StoreAdapter("558", "Botanicus El Rosario", "botanicus_mx", null, 0));
			...
			stores.add(new StoreAdapter("565", "Tanya Moss Santa Teresa", "tanyamoss_mx", null, GetinDump.MALL));
...
//			stores.add(new StoreAdapter("569", "Tanya Moss Isla Perisur", "tanyamoss_mx", null, 0));
			...
			stores.add(new StoreAdapter("422", "Prada Coyoacan", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("423", "Prada Xalapa", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("424", "Prada Galerias Atizapan", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("425", "Prada Galerias Tabasco", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("426", "Prada Altabrisa (Tabasco II)", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("427", "Prada Galerias Serdan", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("428", "Prada Parque Toreo", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("429", "Prada Plaza Mayor", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("430", "Prada Outlet Punta Norte", "prada_mx", null, GetinDump.MALL));  
...
//			stores.add(new StoreAdapter("583", "Prada MTY", "prada_mx", null, 0));
			...
			stores.add(new StoreAdapter("587", "Prada Gran Plaza", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("588", "Prada Merida", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("589", "Prada Paseo Interlomas", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("590", "Prada Outlet Puebla", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("591", "Prada Galerias Coapa", "prada_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("592", "Prada Galerias Toluca", "prada_mx", null, GetinDump.MALL));
...
//			stores.add(new StoreAdapter("598","Sally Beauty Paseo Interlomas", "sallybeauty_mx", null, 0));
			...
			stores.add(new StoreAdapter("606","Squalo Mazatlan 2", "squalo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("607","Squalo San Luis", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("608","Squalo Tuxtla", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("609","Squalo Morelos", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("610","Squalo Merida", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("611","Squalo Morelia.", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("612","Squalo Torreon", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("613","Squalo Manzanillo", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("614","Squalo Chihuahua", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("615","Squalo Gran Plaza", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("616","Squalo Galerias", "squalo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("617","Squalo La Isla", "squalo_mx", null, GetinDump.MALL));
...
//			stores.add(new StoreAdapter("625","Botanicus El Rosario", "botanicus_mx", null, 0));
			...
			stores.add(new StoreAdapter("629","Aditivo Guadalajara", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("630","Aditivo Puebla", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("631","Aditivo Naucalpan", "aditivo_mx", null, GetinDump.MALL));
...
//			stores.add(new StoreAdapter("635","Aditivo Tlalnepantla", "aditivo_mx", null, 0));
			...
			stores.add(new StoreAdapter("639","Aditivo Cuautla", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("640","Aditivo Texcoco", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("641","Aditivo Veracruz", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("642","Aditivo Ixtapaluca", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("643","Aditivo Olivar del conde", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("644","Aditivo Pino Suarez", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("645","Aditivo Puebla 3", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("646","Aditivo Toluca", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("647","Aditivo Tecamac", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("648","Aditivo Lazaro Cardenas", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("649","Aditivo Pachuca", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("650","Aditivo Canal del Norte", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("651","Aditivo Pachuca 2", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("652","Aditivo Ecatepec 2", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("653","Aditivo Queretaro", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("654","Aditivo San Luis", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("655","Aditivo San Luis Centro", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("656","Aditivo Tula", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("657","Aditivo Neza 2", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("658","Aditivo Nicolas Romero", "aditivo_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("659","Aditivo Metro Pino Suarez", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("660","Aditivo Zumpango", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("661","Aditivo Queretaro Centro", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("662","Aditivo Tizayuca", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("663","Aditivo Tuyehualco", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("664","Aditivo 4 Caminos", "aditivo_mx", null, GetinDump.CETRAM));
			stores.add(new StoreAdapter("665","Aditivo Veracruz Centro", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("666","Aditivo Huehuetoca", "aditivo_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("667","Aditivo San Juan del Río", "aditivo_mx", null, GetinDump.FOOT_STREET));
...
//			stores.add(new StoreAdapter("678","Aditivo Alcaraz Circuito", "aditivo_mx", null, 0));
			...
			stores.add(new StoreAdapter("684","Mobo Forum Buenavista", "mobo_mx", "forumbuenavista", GetinDump.MALL));
			...
			stores.add(new StoreAdapter("695","Farmacias Similares Centro 6", "farmacias_similares_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("696","Farmacias Similares Centro 10", "farmacias_similares_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("697","Farmacias Similares Nezahualcóyotl 20", "farmacias_similares_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("698","Farmacias Similares El Olivo", "farmacias_similares_mx", null, GetinDump.FOOT_STREET));
...
//			stores.add(new StoreAdapter("735", "Sportium Patio Santa Fe", "sportium_mx",null, 0));
			...
			stores.add(new StoreAdapter("750", "Chilim Balam Plaza Ciudad Jardín", "chilimbalam_mx", null, GetinDump.MALL));
			stores.add(new StoreAdapter("751", "Chilim Balam Galerías Metepec", "chilimbalam_mx", null, GetinDump.MALL));
			...
			stores.add(new StoreAdapter("771", "Modatelas Morelia IV", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("772", "Modatelas Huahapan De Leon", "modatelas_mx", null, GetinDump.FOOT_STREET));
			stores.add(new StoreAdapter("773", "Modatelas Auatlan De Navarro", "modatelas_mx", null, GetinDump.FOOT_STREET));
			...
			stores.add(new StoreAdapter("780", "Fraiche Guelatao", "fraiche_mx", null, GetinDump.FOOT_STREET));
