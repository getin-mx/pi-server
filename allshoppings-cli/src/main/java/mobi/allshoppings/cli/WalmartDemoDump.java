...
public class WalmartDemoDump extends AbstractCLI {

	public static final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	public static final String MAIN_ENTITY = "wallmartdemo";
	...
	public static void main(String args[]) throws ASException {
		try {
			...
			if( floormaps.size() == 0 ) {
				...
				floormap.setKey((Key)keyHelper.createStringUniqueKey(FloorMap.class, "walmartdemo_pb"));
