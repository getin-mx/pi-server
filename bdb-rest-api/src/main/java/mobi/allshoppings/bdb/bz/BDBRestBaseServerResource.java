						...
						if (fieldValue != null) {
							if (fieldValue instanceof Email) {
								...
								if(((List<?>)fieldValue).size() > 0 ) {
									...
									if(!(o instanceof String) && !(o instanceof Number) && !(o instanceof Key) && !(o instanceof Email) && !(o instanceof Blob) && !(o instanceof Text) && !(o instanceof MultiLang) && !(o instanceof Collection) && !(o instanceof Map)) {
