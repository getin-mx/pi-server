...
public class BDBAPDMABlackListBzServiceJSONImpl extends BDBCrudBzServiceJSONImpl<APDMABlackList> implements BDBCrudBzService {
	...
	public void config() {
		setMyDao(dao);
		setMyClazz(APDMABlackList.class);
	}

	@Override
	public void setKey(APDMABlackList obj, JSONObject seed) throws ASException {
		obj.setKey(dao.createKey());
	}

	@Override
	public void prePersist(APDMABlackList obj, JSONObject seed) throws ASException {
	...
	public String list() {
		...
		try {
			List<APDMABlackList> list = new ArrayList<APDMABlackList>();
