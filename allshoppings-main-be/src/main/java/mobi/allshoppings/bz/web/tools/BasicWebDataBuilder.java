...
public class BasicWebDataBuilder {

	private static final Logger log = Logger.getLogger(BasicWebDataBuilder.class.getName());
	...
	public static void buildBasicData() throws ASException {
		BasicWebDataBuilder bdb = new BasicWebDataBuilder();
